...
namespace Tunnel
{
    ...
    {
        private const string LongName = "AzireVPN";
        private const string Description = "AzireVPN tunnel using WireGuard";
        ...
        public static void Add(string configFile)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (!Win32.DeleteService(service)) // We delete it after starting it so that it's ephemeral
                        throw new Win32Exception(Marshal.GetLastWin32Error());
                }
                finally
                {
